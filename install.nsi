...
!endif
#end powershell support


# define name of installer
OutFile "Canoe123 Additonal Reports Install.exe"
 
# define installation directory
InstallDir "$DOCUMENTS\Canoe123\Reports"
...
Section
    ...
    InitPluginsDir
    ${PowerShellExecFileLog} "$INSTDIR\AddCustomReportsToCanoe123.ps1"
